...
@DPU.AsQuality
public class CompletenessChecker extends AbstractDpu<CompletenessCheckerConfig_V1> {
    ...
    public CompletenessChecker() {
        super(CompletenessCheckerVaadinDialog.class, ConfigHistory.noHistory(CompletenessCheckerConfig_V1.class));
    }
    ...
    protected void innerExecute() throws DPUException {
        ...
        if ((subject_ == null) && (property_ == null)) {
            ...
            // EX_DPU_NAME entity.
            final EntityBuilder reportEntity = new EntityBuilder(CompletenessCheckerVocabulary.EX_DPU_NAME, valueFactory);
            reportEntity
    ...
    private EntityBuilder createObservation(double value, int observationIndex) throws DPUException {
        ...
        String obs = String.format(CompletenessCheckerVocabulary.EX_OBSERVATIONS, observationIndex);
    ...
    private EntityBuilder createObservationBNode(String subject, String property, int observationIndex) throws DPUException {
        ...
        String obs = String.format(CompletenessCheckerVocabulary.EX_OBSERVATIONS, observationIndex) +"/bnode_"+ observationIndex;
        final EntityBuilder observationEntity = new EntityBuilder(valueFactory.createURI(obs), valueFactory);
