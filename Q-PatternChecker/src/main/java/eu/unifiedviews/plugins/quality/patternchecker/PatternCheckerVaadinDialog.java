...
public class PatternCheckerVaadinDialog extends AbstractDialog<PatternCheckerConfig_V1> {

    private GridLayout propertiesGridLayout;

    private ComboBox regExp;

    public PatternCheckerVaadinDialog() {
        super(PatternChecker.class);
    }

    @Override
    public void setConfiguration(PatternCheckerConfig_V1 c) throws DPUConfigException {
    ...
    @Override
    public PatternCheckerConfig_V1 getConfiguration() throws DPUConfigException {
        final PatternCheckerConfig_V1 c = new PatternCheckerConfig_V1();
