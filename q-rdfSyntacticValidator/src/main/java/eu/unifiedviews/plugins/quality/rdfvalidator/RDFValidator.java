...
public class RDFValidator extends AbstractDpu<RDFValidatorConfig_V1> {
    ...
    protected void innerExecute() throws DPUException {
        ...
        // EX_DPU_NAME entity.
        final EntityBuilder reportEntity = new EntityBuilder(RDFValidatorVocabulary.EX_DPU_NAME, valueFactory);
        reportEntity
    ...
    private EntityBuilder createObservation(String type, ArrayList<String> values, int observationIndex) throws DPUException {
        ...
        String obs = String.format(RDFValidatorVocabulary.EX_OBSERVATIONS, observationIndex);
    ...
    private EntityBuilder createObservationBNode(String message, int observationIndex, int bnodeIndex) throws DPUException {
        ...
        String obs = String.format(RDFValidatorVocabulary.EX_OBSERVATIONS, observationIndex) +"/bnode_"+ bnodeIndex;
        final EntityBuilder observationEntity = new EntityBuilder(valueFactory.createURI(obs), valueFactory);
