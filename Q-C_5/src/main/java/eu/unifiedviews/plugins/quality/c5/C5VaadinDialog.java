...
public class C5VaadinDialog extends AbstractDialog<C5Config_V1> {
    ...
    public C5VaadinDialog() {
        super(C5.class);
    }

    @Override
    public void setConfiguration(C5Config_V1 c) throws DPUConfigException {
    ...
    @Override
    public C5Config_V1 getConfiguration() throws DPUConfigException {
        final C5Config_V1 c = new C5Config_V1();
